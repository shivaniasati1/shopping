        ...
        <div class="">
            <div class="card-header" style="background-color: #9C27B0">
                <ul class="nav nav-tabs" data-toggle="tabs">
                    <li class="nav-item">
                    <a class="nav-link" href="{{route('admin.news')}}">Blog</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="{{route('admin.addnew')}}">Add Blog</a>
                    </li>
                </ul>
            </div>
            <div class="card ">
                ...
                <form method="post" action="" class="p-4">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" name="short_des" class="form-control" placeholder="Enter short description">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
