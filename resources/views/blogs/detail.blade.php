            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="post">
                        ...
                        <div class="post-thumbnail"><img src="{{URL::to('/')}}/assets/images/{{$blog->image}}" alt="Blog Featured Image"/></div>
                        <div class="post-header font-alt">
                        <h1 class="post-title">{{$blog->title}}</h1>
                        <div class="post-meta">By&nbsp;<a href="#">{{$blog->author_name}}</a>| {{$blog->created_at->isoFormat('dddd D')}} | 3 Comments | <a href="#">Photography, </a><a href="#">Web Design</a>
                        </div>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-md-offset-1 sidebar">
                    ...
                    <div class="widget">
                        ...
                        <ul class="widget-posts">
                            <li class="clearfix">
                            <div class="widget-posts-image"><a href="#"><img src="{{asset('assets/images/post1.jpg')}}" alt="Post Thumbnail"/></a></div>
                            ...
                            <li class="clearfix">
                            <div class="widget-posts-image"><a href="#"><img src="{{asset('assets/images/post2.jpg')}}" alt="Post Thumbnail"/></a></div>
                            <div class="widget-posts-body">
                            ...
                            <li class="clearfix">
                            <div class="widget-posts-image"><a href="#"><img src="{{asset('assets/images/post4.jpg')}}" alt="Post Thumbnail"/></a></div>
                            <div class="widget-posts-body">
                            ...
                            <li class="clearfix">
                            <div class="widget-posts-image"><a href="#"><img src="{{asset('assets/images/post6.jpg')}}" alt="Post Thumbnail"/></a></div>
                            <div class="widget-posts-body">
