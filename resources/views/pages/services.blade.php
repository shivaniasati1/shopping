...
<section class="module bg-dark-60 service-page-header" data-background="{{asset('assets/images/banner.jpg')}}">
    <div class="container">
        <div class="row">
...
<section class="module" id="alt-features">
    ...
    <div class="row">
        ...
        <div class="alt-services-image align-center"><img src="{{asset('assets/images/service.jpg')}}" alt="Feature Image"></div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3">
        <div class="alt-features-item">
