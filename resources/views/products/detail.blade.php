...
<div class="main">
    <section class="module">
        <div class="container">
        <div class="row">
            <div class="col-sm-6 mb-sm-40"><a class="gallery" href=""><img src="{{asset('assets/images/shop/pro6.jpg')}}" alt="Single Product Image"/></a>
            <ul class="product-gallery">
                <li><a class="gallery" href="{{asset('assets/images/shop/pro10.jpg')}}"></a><img src="{{asset('assets/images/shop/pro10.jpg')}}" alt="Single Product"/></li>
                <li><a class="gallery" href="{{asset('assets/images/shop/pic1.jpg')}}"></a><img src="{{asset('assets/images/shop/pic1.jpg')}}" alt="Single Product"/></li>
                <li><a class="gallery" href="{{asset('assets/images/shop/pro9.jpg')}}"></a><img src="{{asset('assets/images/shop/pro9.jpg')}}" alt="Single Product"/></li>
            </ul>
            </div>
            <div class="col-sm-6">
            <div class="row">
    ...
    <section class="module-small">
        ...
        <div class="row multi-columns-row">
            ...
            <div class="shop-item">
                <div class="shop-item-image"><img src="{{asset('assets/images/shop/pro10.jpg')}}" alt="Accessories Pack"/>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="shop-item">
                <div class="shop-item-image"><img src="{{asset('assets/images/shop/pro9.jpg')}}" alt="Men’s Casual Pack"/>
                <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Add To Cart</span></a></div>
                </div>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="shop-item">
                <div class="shop-item-image"><img src="{{asset('assets/images/shop/pro5.jpg')}}" alt="Men’s Garb"/>
                <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Add To Cart</span></a></div>
                </div>
